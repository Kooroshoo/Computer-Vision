...
def rainier_panorama():
    ...
    save_image(pan, "result/rainier_panorama_1")
    pan2 = panorama_image(pan, im5, thresh=5)
    save_image(pan2, "result/rainier_panorama_2")
    pan3 = panorama_image(pan2, im6, thresh=5)
    save_image(pan3, "result/rainier_panorama_3")
    pan4 = panorama_image(pan3, im3, thresh=5)
    save_image(pan4, "result/rainier_panorama_4")
    pan5 = panorama_image(pan4, im4, thresh=5)
    save_image(pan5, "result/rainier_panorama_5")
